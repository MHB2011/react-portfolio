      ...
      <div className="container">
        ...
        <div className="specials">
          <div>
            ...
            <h3>Idea</h3>
            <p>
              First step is getting idea from the customer. It helps if you can
              be clear with ideas and have some resources and examples of what
          ...
          <div>
            ...
            <h3>Interaction</h3>
            <p>
              In the last step I present my work to customer to see if they like
              it and if any changes are needed. Only when customer is satisfied
              the process is over.
            </p>
          </div>
        </div>
